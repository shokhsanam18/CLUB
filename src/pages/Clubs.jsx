...
const Clubs = () => {
    ...
    const fetchClubData = async () => {
        try {
            ...
            setClubData({
                ...
                description: data.description || API_CONFIG.club.defaultData.description,
    ...
    useEffect(() => {
        Promise.all([fetchClubData(), fetchScores(), fetchLeaders(), fetchEvents()]);
    }, []);
    ...
    return (
        <div className="bg-[#222222]">
                    ...
                    <div className="flex flex-col items-center p-4 md:p-6 bg-opacity-50">
                        <div className="w-40 h-40 rounded-full overflow-hidden border-4 bg-gray-300 border-white shadow-lg mb-4">
                            <img
                                ...
                                onError={(e) => (e.target.src = API_CONFIG.club.defaultData.image)}
                            />
                        </div>
                        <div className="flex justify-center mt-4">
                            <div className="px-4 py-1 rounded-full bg-gradient-to-r from-green-500 to-green-600/60 backdrop-blur-md bg-opacity-40 shadow-md">
                                <Typography variant="small" className="text-lime-400 font-semibold">
            ...
            <div className="w-full p-6">
                <Typography variant="h3" className="text-2xl font-bold mb-6 text-white text-center">
                    Team Leaders
                </Typography>
